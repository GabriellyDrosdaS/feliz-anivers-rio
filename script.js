document.addEventListener("DOMContentLoaded", () => {
    ...
    // Função para mover o retângulo sem sair da tela
    function moveContainer() {
        ...
        const newX = Math.max(0, Math.random() * (windowWidth - rectWidth));
        const newY = Math.max(0, Math.random() * (windowHeight - rectHeight));

        // Atualiza a posição do retângulo
        mainContainer.style.transform = `translate(${newX}px, ${newY}px)`;
    }

    // Adiciona o evento "mouseover" para PCs
    naoBtn.addEventListener("mouseover", moveContainer);

    // Adiciona o evento "touchstart" para dispositivos móveis
...
<p>Com amor, Gabs</p>
            ...
            <!-- Aqui está o GIF que você forneceu -->
            <img src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExeXR3bWszbzQzcGExd2VsZWV2Y2ZsNjF1YWZlNWhxcWR4ZzIzdWdjdiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qvqcMxf6r6krrj9JeR/giphy.gif" alt="Imagem Bonitinha">
            </div>
        `;
